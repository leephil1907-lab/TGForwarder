...
// Bounded concurrency: media prefetches run one after another (never in
// parallel) so a large import burst cannot spike memory on small containers.
let mediaPrefetchChain:Promise<void>=Promise.resolve() as Promise<void>;
